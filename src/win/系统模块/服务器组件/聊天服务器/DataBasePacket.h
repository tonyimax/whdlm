...
#define DBR_GR_UPDATE_PLACENAME		216									//更新地名
...
#define DBR_GR_LOAD_SYSTEM_MESSAGE	310									//系统消息
//用户命令
...
#define DBR_GR_MATCH_SIGNUP				500								//申请报名
#define DBR_GR_MATCH_UNSIGNUP			501								//取消报名
#define DBO_GR_MATCH_SIGNUP_RESULT		520								//报名结果
#define DBO_GR_MATCH_UNSIGNUP_RESULT	521								//退赛结果
#define DBO_GR_MY_MATCH_HISTORY			522								//我的比赛
#define DBO_GR_MATCH_HISTORY_RESULT_T	523								//比赛结果-成功
#define DBO_GR_MATCH_HISTORY_RESULT_F	524								//比赛结果-失败
//////////////////////////////////////////////////////////////////////////////////
...
struct DBO_GR_LogonSuccess
{
	...
	TCHAR							szFaceUrl[LEN_FACE_URL];			//微信头像地址
};
...
//我的比赛结果
struct DBO_GR_MyMatchHistoryResult
{
