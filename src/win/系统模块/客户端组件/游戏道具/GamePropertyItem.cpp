...
LPCTSTR CGamePropertyCar::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 送给 [ %s ] %d 辆豪华跑车，好拉风啊！"),szSourceNickName,szTargerNickName,wItemCount);
...
LPCTSTR CGamePropertyEgg::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR  szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 丢给 [ %s ] %d 颗臭鸡蛋，臭名远扬了！"),szSourceNickName,szTargerNickName,wItemCount);
...
LPCTSTR CGamePropertyClap::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR   szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 为 [ %s ]热烈鼓掌，你是最棒的！"),szSourceNickName,szTargerNickName);
...
LPCTSTR CGamePropertyKiss::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 献给 [ %s ] %d 个香吻，好害羞呀！"),szSourceNickName,szTargerNickName,wItemCount);
...
LPCTSTR CGamePropertyBeer::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR  szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 与 [ %s ]干杯，一醉方休！"),szSourceNickName,szTargerNickName);
...
LPCTSTR CGamePropertyCake::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR  szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 送给 [ %s ] %d 块蛋糕，友谊天长地久！"),szSourceNickName,szTargerNickName,wItemCount);
...
LPCTSTR CGamePropertyRing::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR  szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 送给 [ %s ] %d 玫钻戒，幸福甜蜜的人儿！"),szSourceNickName,szTargerNickName,wItemCount);
...
LPCTSTR CGamePropertyBeat::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 把 [ %s ]暴打了一顿，这个社会不太和谐！"),szSourceNickName,szTargerNickName);
...
LPCTSTR CGamePropertyBomb::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR  szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 丢了 %d 颗炸弹给 [%s]，可恶的家伙！"),szSourceNickName,wItemCount,szTargerNickName);
...
LPCTSTR CGamePropertySmoke::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 递给 [ %s ] %d 支香烟，大家趣味相投！"),szSourceNickName,szTargerNickName,wItemCount);
...
LPCTSTR CGamePropertyVilla::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 送给 [ %s ] %d 栋别墅，霸气外露！"),szSourceNickName,szTargerNickName,wItemCount);
...
LPCTSTR CGamePropertyBrick::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 拍了 [ %s ] %d 砖头，[%s] 你晕了吗？"),szSourceNickName,szTargerNickName,wItemCount,szTargerNickName);
...
LPCTSTR CGamePropertyFlower::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("[ %s ] 献给 [ %s ] %d 束鲜花，[%s]脸蛋儿红通通！"),szSourceNickName,szTargerNickName,wItemCount,szTargerNickName);
...
LPCTSTR CGamePropertyTwoScoreCard::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，%d小时内您游戏赢分将获得双倍积分，输分不多扣。"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。%d小时内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyFourScoreCard::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，四倍积分卡即时生效，%d小时内您游戏赢分将获得四倍积分，输分不多扣。"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您四倍积分卡道具，即时生效。%d小时内您游戏赢分将获得四倍积分，\n输分不多扣。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyScoreClear::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName,szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，负分清零即时生效，您的游戏积分已经恢复初始状态。"),szSourceNickName,wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您负分清零道具，即时生效。您的游戏积分已经恢复初始状态。 "),szSourceNickName);
...
LPCTSTR CGamePropertyEscapeClear::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName,szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，逃跑清零即时生效，您的逃跑率已经恢复初始状态。"),szSourceNickName,wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您逃跑清零道具，即时生效。您的逃跑率已经恢复初始状态。 "),szSourceNickName);
...
LPCTSTR CGamePropertyTrumpet::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您，[ %s ]玩家了赠送了您%d个小喇叭道具，即送即用。该道具作用您发送的消息将在房间内的聊天框内以醒目的方式显示。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyTyphon::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	//定义变量
	TCHAR szMessage[128]=TEXT("");
	_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您，[ %s ]玩家了赠送了您%d个大喇叭道具，即送即用。该道具作用您发送的消息将在大厅和全服的所有游戏里以醒目的方式显示。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyGuardKickCard::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，防踢卡即时生效，%d小时内您不用担心被会员踢出游戏桌。"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT(" 恭喜您！[ %s ]玩家赠送了您防踢卡道具，即时生效。%d小时内，您不用担心被会员踢出游戏桌。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyPossess::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身符即时生效，%d小时内您游戏输分不扣分，赢分正常得分。"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身符道具，即时生效。%d小时内您游戏输分不扣分，赢分正常得分。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyBlueRingCard::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，蓝钻会员卡即时生效，%d月内您可以享受蓝钻会员的尊贵权限。"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您蓝钻会员卡道具，即时生效。%d月内您可以享受蓝钻会员的尊贵权限。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyYellowRingCard::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，黄钻会员卡即时生效，%d月内您可以享受黄钻会员的尊贵权限。"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您黄钻会员卡道具，即时生效。%d月内您可以享受黄钻会员的尊贵权限。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyWhiteRingCard::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，白钻会员卡即时生效，%d月内您可以享受白钻会员的尊贵权限。"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您白钻会员卡道具，即时生效。%d月内您可以享受白钻会员的尊贵权限。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyRedRingCard::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，红钻会员卡即时生效，%d月内您可以享受红钻会员的尊贵权限。"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您红钻会员卡道具，即时生效。%d月内您可以享受红钻会员的尊贵权限。"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyVipRoomCard::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，VIP会员卡即时生效，%d月内您可以享受VIP会员的尊贵权限！"),wItemCount);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您VIP会员卡道具，即时生效。%d月内您可以享受VIP会员的尊贵权限！"),szSourceNickName,wItemCount);
...
LPCTSTR CGamePropertyCrystal::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，恭喜您获得%d游戏币！"),wItemCount*m_PropertyItem.lUseResultsGold);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的水晶，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
LPCTSTR CGamePropertyAgate::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	if(szSourceNickName==szTargerNickName)
		...
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的玛瑙，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
LPCTSTR CGamePropertyBoulder::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，玉石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyItem.lUseResultsGold);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的玉石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
LPCTSTR CGamePropertyGem::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，宝石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyItem.lUseResultsGold);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的宝石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
LPCTSTR CGamePropertyDiamond::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，钻石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyItem.lUseResultsGold);
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的钻石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
LPCTSTR CGamePropertyDouble1Hour::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，1小时内您游戏赢分将获得双倍积分，输分不多扣。"));
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。1小时内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName);
...
LPCTSTR CGamePropertyDouble3Hour::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，3小时内您游戏赢分将获得双倍积分，输分不多扣。"));
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。3小时内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName);
...
LPCTSTR CGamePropertyDouble1Day::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，1天内您游戏赢分将获得双倍积分，输分不多扣。"));
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。1天内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName);
...
LPCTSTR CGamePropertyDouble1Week::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，1周内您游戏赢分将获得双倍积分，输分不多扣。"));
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。1周内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName);
...
LPCTSTR CGamePropertyAmulet1Hour::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身卡即时生效，1小时内您游戏输分不扣分，赢分正常得分。"));
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身卡道具，即时生效。1小时内您游戏输分不扣分，赢分正常得分。"),szSourceNickName);
...
LPCTSTR CGamePropertyAmulet3Hour::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身卡即时生效，3小时内您游戏输分不扣分，赢分正常得分。"));
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身卡道具，即时生效。3小时内您游戏输分不扣分，赢分正常得分。"),szSourceNickName);
...
LPCTSTR CGamePropertyAmulet1Day::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身卡即时生效，1天内您游戏输分不扣分，赢分正常得分。"));
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身卡道具，即时生效。1天内您游戏输分不扣分，赢分正常得分。"),szSourceNickName);
...
LPCTSTR CGamePropertyAmulet1Week::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身卡即时生效，1周内您游戏输分不扣分，赢分正常得分。"));
	else
		_sntprintf_s(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身卡道具，即时生效。1周内您游戏输分不扣分，赢分正常得分。"),szSourceNickName);
