...
VALUES  ( 1 , N'1万游戏币' , N'http://imageqj.foxuc.net/Match/47.png' , 10,10000 , 0 ,0 , 1 ,0 ,GETDATE())
INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 1 , N'5万游戏币' , N'http://imageqj.foxuc.net/Match/48.png' , 50,50000 , 0 ,0 , 2 ,0 ,GETDATE())
INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 1, N'100万游戏币' , N'http://imageqj.foxuc.net/Match/49.png' , 95,1000000 , 0 ,0 , 3 ,0 ,GETDATE())
INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 1, N'500万游戏币' , N'http://imageqj.foxuc.net/Match/50.png' , 490,5000000 , 0 ,0 , 4 ,0 ,GETDATE())

INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 2 , N'热水壶' , N'http://imageqj.foxuc.net/Match/47.png' , 100,0 , 0 ,80 , 1 ,0 ,GETDATE())
INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 2 , N'纸巾' , N'http://imageqj.foxuc.net/Match/48.png' , 40,0 , 0 ,4985 , 2 ,0 ,GETDATE())

INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 3 , N'小米耳机' , N'http://imageqj.foxuc.net/Match/47.png' , 7000,0 , 0 ,50 , 1 ,0 ,GETDATE())
INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 3 , N'万能充电宝' , N'http://imageqj.foxuc.net/Match/48.png' , 90,0 , 0 ,7998 , 2 ,0 ,GETDATE())
INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 3 , N'IphoneX' , N'http://imageqj.foxuc.net/Match/49.png' , 99999999,0 , 0 ,10 , 3 ,0 ,GETDATE())

INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 4 , N'100元京东券' , N'http://imageqj.foxuc.net/Match/47.png' , 8000,0 , 0 ,6000 , 1 ,0 ,GETDATE())
INSERT INTO dbo.AwardInfo( AwardType ,AwardName ,AwardImg ,UnitPrice ,Gold ,Diamond ,Inventory ,SortID ,Nullity ,CollectDate)
VALUES  ( 4 , N'沃尔玛100元购物券' , N'http://imageqj.foxuc.net/Match/48.png' , 6000,0 , 0 ,3999 , 2 ,0 ,GETDATE())
