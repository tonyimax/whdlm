...
osql -E -i "%rootPath%俱乐部奖励勋章提取分页.sql"
osql -E -i "%rootPath%俱乐部玩家勋章流水分页.sql"
osql -E -i "%rootPath%俱乐部战绩分页.sql"
osql -E -i "%rootPath%游戏控制大联盟房间分页.sql"
osql -E -i "%rootPath%游戏控制大联盟分页.sql"
osql -E -i "%rootPath%增减账号大联盟分页.sql"
osql -E -i "%rootPath%增减账号大联盟用户分页.sql"
...
set rootPath=5升级脚本\
osql -E -i "%rootPath%V1.1.1升级脚本.sql"
osql -E -i "%rootPath%微信扫码登录.sql"
