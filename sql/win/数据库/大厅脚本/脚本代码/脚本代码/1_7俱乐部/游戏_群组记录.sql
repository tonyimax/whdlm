...
BEGIN
	...
	SELECT A.KindName,A.RoomID,A.DrawCount,A.MinTableScore,A.StartTime FROM [RecordGroupRoomInfo] A where A.RoomID=@dwRoomID AND A.GroupID=@dwGroupID AND  A.EndTime=@EndTime--CONVERT(int,CONVERT(nvarchar(8),A.EndTime,112))=@dwDateID
END
