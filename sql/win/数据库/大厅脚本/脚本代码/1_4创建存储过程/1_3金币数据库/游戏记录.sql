...
BEGIN
	...
	INSERT INTO WHQJGroupDB..RecordGroupRoomInfo(GroupID,RoomID,PlayMode,KindID,KindName,DrawCount,BigWinnerID,BigWinnerName,MinTableScore,RoomRevenue,StartTime,EndTime)
					VALUES(@dwGroupID,@dwRoomID,@cbPlayMode,@wKindID,@szServerName,@wDrawCount,ISNULL(@dwWinnerGameID, 0),ISNULL(@szWinnerName, ''),@lMinEnterScore,@lRoomRevenue,@SystemTimeStart,@SystemTimeConclude)
...
BEGIN
	...
	BEGIN
		...
		SET DrawCount=DrawCount+1,BigWinnerCount=BigWinnerCount+@cbBigWinner, ScoreCount=ScoreCount+@lScore+@lRevenue, RevenueCount=RevenueCount+@lRevenue ,CurScore=@CurUserScore-@lRevenue 
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				set DrawCount=DrawCount+1,BigWinnerCount=BigWinnerCount+@cbBigWinner,ScoreCount=ScoreCount+@lScore+@lRevenue,RevenueCount=RevenueCount+@lRevenue,ContributionValue=ContributionValue+@TempRevenue
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				update   WHQJGroupDB.dbo.RecordTeamDayInfo 
				set DrawCount=DrawCount+1,BigWinnerCount=BigWinnerCount+@cbBigWinner,ScoreCount=ScoreCount+@lScore+@lRevenue,RevenueCount=RevenueCount+@lRevenue
		...
		BEGIN
			...
			BEGIN
				...
				values(@dateID,@dwGroupID,@dwCaptainID,1,@cbBigWinner,@lScore+@lRevenue,@lRevenue,0)
			END
